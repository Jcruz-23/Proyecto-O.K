...
void menu(Nodo *Matricula, Nodo *Trayectoria);
...
void mostrarNodo(Nodo *Matricula, Nodo *Trayectoria);
...
void verTodasLasProvincias(Nodo *Matricula, Nodo *Trayectoria);
...
void verTodosLosTipos(Nodo *Matricula, Nodo *Trayectoria);
...
void buscarPorProvincia(Nodo *Matricula, Nodo *Trayectoria);
...
void buscarPorAnio(Nodo *Matricula, Nodo *Trayectoria);
...
void buscarPorTipo(Nodo *Matricula, Nodo *Trayectoria);
...
void liberarMemoria(Nodo *Matricula, Nodo *Trayectoria);
