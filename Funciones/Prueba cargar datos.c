...
void ImprimirLista(NodoTrayectoria *registro) {
  ...
  fprintf(archivo,
    ...
    de ser de la primera columna y unificar las provincias ya que en el archivo
    estan repetidas porque lo hace por departamentos (si queremos tambbien
    contar los alumnos por departamento no hace falta), ya que no vamos a
    utilizar todas las columnas y las funciones fscanf y fprintf estan hechas
    para leer lineas, hay que ver como analizar solo las que queremos. una vez
    guardadas en un nodo pasaremos al siguiente donde analizaremos el archivo de
    2020 y luego al siguiente sonde analizaremos el de 2021 fclose(archivo); }
