...
int main(){
    ...
    while(fscanf(matricula2019, "%19[^,],%9[^,],%d,%d,%d,%d,%d,%d,%d,%d,%d,%d,%d,%d",provincia, tipo, rM.repitentes[0],rM.repitentes[1],rM.repitentes[2],rM.repitentes[3],rM.repitentes[4],rM.repitentes[5],rM.matriculas[0],rM.matriculas[1],rM.matriculas[2],rM.matriculas[3],rM.matriculas[4],rM.matriculas[5]) == 14){
        agregar(&m, rM, id, provincia, tipo);
    }
